...
export default function App() {
  ...
  // Gera o HTML do email compatível com Outlook (tabelas, bgcolor, sem gradient/flex/rgba)
  ...
  <tr>
    <td align="center" bgcolor="#C5CDD4" style="padding:32px 16px;">
      ...
      <table width="780" cellpadding="0" cellspacing="0" border="0">
        ...
        <!-- STRIPE -->
        <tr>
          <td height="4" bgcolor="#1565A6" style="background:linear-gradient(90deg,#1565A6,#2BBD5A);font-size:0;line-height:0;mso-line-height-rule:exactly;">&nbsp;</td>
        </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                ...
                <td valign="middle" align="right">
                  <span style="font-size:11px;color:#7A9AAD;font-family:${fontStack};">${footerText}</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <!-- BOTTOM BAR -->
        <tr>
          <td height="6" bgcolor="#2BBD5A" style="background:linear-gradient(90deg,#1565A6,#2BBD5A);font-size:0;line-height:0;mso-line-height-rule:exactly;">&nbsp;</td>
        </tr>
